...
# Константы
bot = telebot.TeleBot("5835368673:AAGEwWY45J3KnnsFlqd2g4DrPIfFdpUQLe4")
SUBJECTS = {
...
def handle_text(message):
    if message.text == "Есть":
        ...
        bot.send_message(message.chat.id,
                         "<a href='https://github.com/newtover/dnevnik'>Вот инструкция</a> по получению ID",
...
def makeID(message):
    ...
    bot.send_message(288076865,
                     "Челик привязал дневник!\n Username: " + str(message.from_user.username) + " ID: " + str(
